...
func init() {
	...
	cfg.DefaultReleaseBranch = newCmd.Flags().String("defaultreleasebranch", "", "default branch to release from")
	...
	cfg.GoTest = newCmd.Flags().Bool("gotest", false, "enable go test")
